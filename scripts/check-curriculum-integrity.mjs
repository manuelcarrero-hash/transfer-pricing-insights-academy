...
for (const code of ['c1','c2','c3','c4','c5','c6','c7','ss1','ss2','ss3','ss4','ss5','ss6','ss7','ss8','s1','s2','s3','s4','s5','s6','s7']) {
...
if (!process.exitCode) console.log('Curriculum integrity check passed.');
