...
import { C1AssessmentPage } from '../pages/C1AssessmentPage';
import { C1CoursePage } from '../pages/C1CoursePage';
import { C1LessonPage } from '../pages/C1LessonPage';
import { C2AssessmentPage } from '../pages/C2AssessmentPage';
import { C2CoursePage } from '../pages/C2CoursePage';
import { C2LessonPage } from '../pages/C2LessonPage';
import { C3AssessmentPage } from '../pages/C3AssessmentPage';
import { C3CoursePage } from '../pages/C3CoursePage';
import { C3LessonPage } from '../pages/C3LessonPage';
