...
export function MyPathPage() {
  ...
  const allJuniorComplete = courses.every(({ lessons, progress }) => progress.completedLessons.length === lessons.length);
