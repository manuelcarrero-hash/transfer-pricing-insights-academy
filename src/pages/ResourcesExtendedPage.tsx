...
const resources: LibraryResource[] = [
  ...
  { id:'c3-dataset', category:'Datasets', level:'Consultant', type:'Dataset didáctico', title:'C3 — Dataset TNMM / MTUO v1.0', description:'Datos de práctica para Operating Margin, Mark-up on Costs, Berry Ratio, ROA y segmentación.', href:'https://drive.google.com/uc?export=download&id=1_1KV_MMz3Ia-3E9KVM7gJS9KhaRod90pXsgjMceL_OY' },
